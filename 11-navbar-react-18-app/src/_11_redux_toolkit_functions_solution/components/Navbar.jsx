...
import { navbarActions } from "./../redux/navbar/navbar-slice";
import { useSelector, useDispatch } from "react-redux";

export default function Navbar() {
  const dispatch = useDispatch();
  const { showLinks } = useSelector((state) => state.navbarState);
      ...
      <div className="nav-center">
        ...
        <div className="nav-header">
          ...
          <button
            ...
            onClick={() => dispatch(navbarActions.setShowLinks(!showLinks))}
          >
            <FaBars />
          </button>
        </div>
