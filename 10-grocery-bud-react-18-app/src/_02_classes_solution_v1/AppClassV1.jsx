...
function retrieveLocalStorage() {
  let itemsList = localStorage.getItem("itemsListClassV1");
  if (itemsList) {
    return JSON.parse(localStorage.getItem("itemsListClassV1"));
  } else {
    return [];
  }
}
  ...
  render() {
    return (
      <section className="section-center ">
        <p>class solution version 1: global state + showAlert()</p>
