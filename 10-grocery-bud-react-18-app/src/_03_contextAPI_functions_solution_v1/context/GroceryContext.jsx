...
const retrieveLocalStorage = () => {
  let itemsList = localStorage.getItem("itemsListContextAPI_V1");
  if (itemsList) {
    return JSON.parse(localStorage.getItem("itemsListContextAPI_V1"));
  } else {
    return [];
  }
};
...
export default function GroceryContextProvider(props) {
  ...
  useEffect(() => {
    localStorage.setItem("itemsListContextAPI_V1", JSON.stringify(itemsList));
  }, [itemsList]);
