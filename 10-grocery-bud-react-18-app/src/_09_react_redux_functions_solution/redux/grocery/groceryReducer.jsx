...
const retrieveLocalStorage = () => {
  let itemsList = localStorage.getItem("grocery_redux_functions");
  if (itemsList) {
    return JSON.parse(localStorage.getItem("grocery_redux_functions"));
  } else {
    return [];
  }
};
...
export const groceryReducer = (state = initialGroceryState, action) => {
  switch (action.type) {
