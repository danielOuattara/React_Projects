    ...
    return (
      <article className="review">
        ...
        <div className="button-container">
          <button className="prev-btn" onClick={this.props.getPreviousQuote}>
            <FaChevronLeft />
          </button>
          <button className="next-btn" onClick={this.props.getNextQuote}>
            <FaChevronRight />
          </button>
        </div>
        <div className="button-container">
          <button className="random-btn" onClick={this.props.getRandomQuote}>
            surprise me
          </button>
        </div>
      </article>
