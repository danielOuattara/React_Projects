...
import { reviewsAction } from "../store/reviews/reviews-slice";
...
const masDispatchToProps = (dispatch) => {
  return {
    handlePreviousQuote: () => {
      return dispatch(reviewsAction.getPreviousQuote());
    },

    handleNextQuote: () => {
      return dispatch(reviewsAction.getNextQuote());
    },

    handleRandomQuote: () => {
      return dispatch(reviewsAction.getRandomQuote());
    },
  };
};
